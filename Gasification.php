...
<head>
    ...
    <title class="lng-services-aside_link2-2">Газификация Дома</title>
</head>
<body>
    ...
    <div class="container">
      <ul class="row">
        <li class="col-md-12 col-sm-12 col-xs-12">
            <h2 class="service_description_header lng-description_header2">Газификация дома</h2>
          </li> 
        <li class="col-md-6 col-sm-6 col-xs-12">
          <div class="service_description_content">
            <img class="service_description_content_img" src="./img/services page/gazificaciya-doma-430x287.jpg" alt="">
            </div>
          </li>
        <li class="col-md-6 col-sm-6 col-xs-12">
        <div class="service_description_content">
              <h4 class="service_description_content_heading lng-description_content_heading2">Газификация своего дома</h4>
              <p class="service_description_content_info lng-description_content_info2">
              Газификация дома – это прежде всего решение вопроса с отоплением и горячей водой в частном доме, который в то же время можно решить по-разному: электричеством, твердым топливом, энергией солнца, ветра, воды. Но все же лидером среди ресурсов является газ, поэтому газификация загородного дома – отличный вариант для тех, кто не привык экономить на своем комфорте.
              <br>
              И если рядом проложена газовая магистраль, можно сделать ответвление к своему участку. А как именно это осуществить и оформить – мы рассмотрим в этой статье. Уделим внимание вопросам составления проекта и оформления необходимой документации – поэтапно рассмотрим каждый шаг, без которого газификация вашего дома невозможна.
              </p>
            </div>
          </li>
        </ul>
        ...
        <div class="container">
            ...
            <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top"><b class="lng-service-card-heading7">К магистральным сетям вне земельного участка</b>
                    <p class="section-favor_features lng-service-card-descr7">Примерная стоимость работы по газоснабжению.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
                    <p class="section-favor_bordery_price">300</p><p class="somoni lng-somoni6"> сомони</p>
              ...
              <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  ...
                  <b class="lng-service-card-heading8">К газопроводу в пределах земельного участка</b>
                    <p class="section-favor_features lng-service-card-descr8">Примерная стоимость работы по газоснабжению.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
                    <p class="section-favor_bordery_price">250</p><p class="somoni lng-somoni2"> сомони</p>
                    <button class="section-favor_bordery_btn">
              ...
              <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top">
                  <b class="lng-service-card-heading9">От газопровода на фасаде дома</b>
                    <p class="section-favor_features lng-service-card-descr9">Примерная стоимость работы по газоснабжению.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
                    <p class="section-favor_bordery_price">200</p><p class="somoni lng-somoni3"> сомони</p>
                    <button class="section-favor_bordery_btn">
