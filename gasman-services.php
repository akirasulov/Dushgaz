...
<head>
    ...
    <title class="lng-services-aside_link1-1">Услуги Газовщика</title>
</head>
<body>
    ...
    <div class="container">
      <ul class="row">
        <li class="col-md-12 col-sm-12 col-xs-12">
            <h2 class="service_description_header lng-description_header1">Услуги Газовщика</h2>
          </li> 
        <li class="col-md-6 col-sm-6 col-xs-12">
          <div class="service_description_content">
            <img class="service_description_content_img" src="./img/services page/services-1-775x517.jpg" alt="">
            </div>
          </li>
        <li class="col-md-6 col-sm-6 col-xs-12">
        <div class="service_description_content">
              <h4 class="service_description_content_heading lng-description_content_heading1">Описание услуг газовщика</h4>
              <p class="service_description_content_info lng-description_content_info1">
              Услуги газовщика могут быть различны, это замена газовой подводки и запорного крана, установка нового бытового газового оборудования, а так же ремонт или прочистка старого, такого как плиты и колонки.
              <br>
              Работы с газовым оборудованием имеют право выполнять только обученные специалисты. Для этого необходимо пройти обучение по специальности слесарь по эксплуатации и ремноту газового оборудования. После обучения для подтверждения квалификации нужно ежегодно сдавать экзамен. Все специалисты имеют данный допуск, газовщик обязан предоставить его при первом требовании абонента. 
              </p>
            </div>
          </li>
        </ul>
        ...
        <div class="container">
            ...
            <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top"><b class="lng-service-card-heading1">Ремонт газового оборудования</b>
                    <p class="section-favor_features lng-service-card-descr1">Ремонт газового оборудования производится на дому абонента.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
                    <p class="section-favor_bordery_price">100</p><p class="somoni lng-somoni"> сомони</p>
              ...
              <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  ...
                  <b  class="lng-service-card-heading2">Работа газовщика по замене крана</b>
                    <p class="section-favor_features lng-service-card-descr2">Работа по замене крана и(или) шланга приравнивается к минимальной стоимости работ при вызове газовщика. Данная стоимость включает вызов специалиста. Устанавливаемое оборудование не входит в стоимость.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
                    <p class="section-favor_bordery_price">150</p><p class="somoni lng-somoni2"> сомони</p>
                    <button class="section-favor_bordery_btn">
              ...
              <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top">
                  <b  class="lng-service-card-heading3">Ремонт газового оборудования</b>
                    <p class="section-favor_features lng-service-card-descr3">Ремонт газового оборудования производится на дому абонента. Стоимость ремонта определяется на адресе перед проведением работ. Вызов мастера на диагностику составляет 500 рублей.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
                    <p class="section-favor_bordery_price">100</p><p class="somoni lng-somoni3"> сомони</p>
                    <button class="section-favor_bordery_btn">
              ...
              <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top">
                  <b  class="lng-service-card-heading4">Вызов и осмотр газовщика по пригороду</b>
                    <p class="section-favor_features lng-service-card-descr4">Цена за услугу указана по пригороду.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
                    <p class="section-favor_bordery_price">100</p><p class="somoni lng-somoni4"> сомони</p>
                    <button class="section-favor_bordery_btn">
              ...
              <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top">
                  <b  class="lng-service-card-heading5">Вызов и осмотр газовщика по Душанбе</b>
                    <p class="section-favor_features lng-service-card-descr5">Цена за услугу указана по Душанбе.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
                    <p class="section-favor_bordery_price">50</p><p class="somoni lng-somoni5"> сомони</p>
                    <button class="section-favor_bordery_btn">
              ...
              <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top">
                  <b class="lng-service-card-heading6">Подключение газовой плиты в Душанбе</b>
                    <p class="section-favor_features lng-service-card-descr6">В стоимость входит Вызов, услуги по установке. Цена за услугу указана по Душанбе.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
                    <p class="section-favor_bordery_price">180</p><p class="somoni lng-somoni6"> сомони</p>
                    <button class="section-favor_bordery_btn">
