...
<head>
    ...
    <title class="lng-services-aside_link9-9">Ремонт Газовой Колонки</title>
</head>
<body>
...
<aside class="category"> 
    ...
    <div class="container">
      <ul class="row">
        <li class="col-md-12 col-sm-12 col-xs-12">
            <h2 class="service_description_header lng-description_header9">Ремонт газовой колонки</h2>
          </li>
        <li class="col-md-6 col-sm-6 col-xs-12">
          <div class="service_description_content">
            <img class="service_description_content_img" src="./img/services page/remont-gazovyh-vodonagrevatelej.jpg" alt="">
            </div>
          </li>
        <li class="col-md-6 col-sm-6 col-xs-12">
        <div class="service_description_content">
              <h4 class="service_description_content_heading lng-description_content_heading9">Описание услуги ремонт газовой колоноки</h4>
              <p class="service_description_content_info lng-description_content_info9">
              Мастер по ремонту газовой колонки даст Вам профессиональную консультацию. Подсчитает стоимость ремонта и предложит оптимальное решение в каждом отдельном случае.<br> Мастера по ремонту и обслуживанию газовых колонок – это не только сертифицированные сотрудники, но и специалисты с большим опытом и стажем работы. К нам обращаются за ремонтом или сервисным обслуживанием таких газовых колонок, как Нева, Балтгазкомфорт, Bosh, Electrolux, Ariston, Baxi, Vaillant и другие.
              </p>
            </div>
          </li>
        </ul>
    ...
    <section class="section-favor">
        <div class="container">
            <ul class="row">
            <li class="col section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top"><b class="lng-service-card-heading33">Обслуживание газовой колонки по Душанбе</b>
                    <p class="section-favor_features lng-service-card-descr33">В стоимость входит Вызов, диагностика, услуги по обслуживанию или ремонту. Цена за услугу указана по Душанбе.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
                    <p class="section-favor_bordery_price">300</p><p class="somoni lng-somoni"> сомони</p>
              ...
              <li class="col section-favor_container">
                <div class="section-favor_bordery">
                  ...
                  <b class="lng-service-card-heading34">Облуживание газовой колонки по пригороду</b>
                    <p class="section-favor_features lng-service-card-descr34">В стоимость входит Вызов, диагностика, услуги по обслуживанию. Цена за услугу указана по пригороду.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
              ...
              <li class="col section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top"><b class="lng-service-card-heading35">Обслуживание газовой колонки по Душанбе</b>
                    <p class="section-favor_features lng-service-card-descr35">В стоимость входит Вызов, диагностика, услуги по обслуживанию или ремонту. Цена за услугу указана по Душанбе.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
                    <p class="section-favor_bordery_price">300</p><p class="somoni lng-somoni3"> сомони</p>
                    <button class="section-favor_bordery_btn">
              ...
              <li class="col section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top">
                  <b class="lng-service-card-heading36">Облуживание газовой колонки по пригороду</b>
                    <p class="section-favor_features lng-service-card-descr36">В стоимость входит Вызов, диагностика, услуги по обслуживанию. Цена за услугу указана по пригороду.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
