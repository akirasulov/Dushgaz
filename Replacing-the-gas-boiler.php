...
<head>
    ...
    <title class="lng-services-aside_link7-7">Демонтаж Газовых Труб</title>
</head>
<body>
    ...
    <div class="container">
      <ul class="row">
        <li class="col-md-12 col-sm-12 col-xs-12">
            <h2 class="service_description_header lng-description_header7">Замена газового котла</h2>
          </li>
        <li class="col-md-6 col-sm-6 col-xs-12">
          <div class="service_description_content">
            <img class="service_description_content_img" src="./img/services page/Zamena-gazovogo-kotla.jpg" alt="">
            </div>
          </li>
        <li class="col-md-6 col-sm-6 col-xs-12">
        <div class="service_description_content">
              <h4 class="service_description_content_heading lng-description_content_heading7">Как заменить газовый котел</h4>
              <p class="service_description_content_info lng-description_content_info7">
              Думаете произвести замену газового котла? Перед тем как проводить работы, получите грамотную консультацию нашего специалиста. Мы расскажем, какие нормативы должны быть соблюдены, какой котел лучше всего выбрать, подскажем как использовать новое оборудование и обеспечим выполнение работ в кротчайшие сроки.
              </p>
            </div>
          </li>
        </ul>
        ...
        <div class="container">
            ...
            <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top"><b class="lng-service-card-heading21">Вызов мастера на диагностику и составление сметы</b>
                    <p class="section-favor_features lng-service-card-descr21">Вызов мастера для осмотра объма работ, составления сметы и визуальной диагностики существующей системы отопления.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
                    <p class="section-favor_bordery_price">50</p><p class="somoni lng-somoni"> сомони</p>
              ...
              <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  ...
                  <b class="lng-service-card-heading22">Монтаж настенного котла (одноконтурный)</b>
                    <p class="section-favor_features lng-service-card-descr22">Пусконаладка газового котла при условии что система заполнена теплоносителем и готова к эксплуатации.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
                    <p class="section-favor_bordery_price">80</p><p class="somoni lng-somoni2"> сомони</p>
                    <button class="section-favor_bordery_btn">
              ...
              <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top">
                  <b class="lng-service-card-heading23">Монтаж настенного котла (двухконтурный)</b>
                    <p class="section-favor_features lng-service-card-descr23">Пусконаладка газового котла при условии что система заполнена теплоносителем и готова к эксплуатации.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
            ...
            <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top"><b class="lng-service-card-heading24">Монтаж напольного котла до 60 кВт</b>
                    <p class="section-favor_features lng-service-card-descr24">Установка напольного котла до 60 кВт, подключение к дымоходу, подключение к системе отопления и водоснабжения без перемонтажа.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
                    <p class="section-favor_bordery_price">140</p><p class="somoni lng-somoni4"> сомони</p>
                    <button class="section-favor_bordery_btn">
              ...
              <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top">
                  <b class="lng-service-card-heading25">Монтаж напольного котла до 140 кВт</b>
                    <p class="section-favor_features lng-service-card-descr25">Установка напольного котла до 140 кВт, подключение к дымоходу, подключение к системе отопления и водоснабжения без перемонтажа.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
                    <p class="section-favor_bordery_price">200</p><p class="somoni lng-somoni5"> сомони</p>
                    <button class="section-favor_bordery_btn">
              ...
              <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top">
                  <b class="lng-service-card-heading26">Монтаж напольного котла более 140 кВт</b>
                    <p class="section-favor_features lng-service-card-descr26">Установка напольного котла до 140 кВт, подключение к дымоходу, подключение к системе отопления и водоснабжения без перемонтажа. Цена по договоренности</p>
                  </div>
                    <div class="section-favor_bordery_direction">
