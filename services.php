...
<head>
    ...
    <title class="lng-title-services">Услуги</title>
</head>
<body>
...
<div class="menu menuEffects">
  ...
  <div class="menuContent">
        ...
        <div class="section_head_content_services">
            ...
            <ul class="section_head_content_list">
                <li class="section_head_content_list_item">
                    <a href="./index.php" class="section_head_content_list_item_link lng-head-services-link">Главная</a>
                </li>
                <li class="section_head_content_list_item">
                    <p href="./services.php" class="section_head_content_list_item_text lng-head-services2">Услуги</p>
                </li>
            </ul>
        </div>
    </section>
    ...
    <section>
      ...
      <div class="cont">
        <div class="box">
          <a class="lng-dropdown3" href="./services-type-equipment.php">Услуги по виду оборудования</a>
          <img  class="box_img" src="./img/1.jpg">
        </div>
        <div class="box">
          <a class="lng-dropdown4" href="./services-type-work.php">Услуги по виду работ</a>
          <img src="./img/2.jpg">
        </div>
      </div>
      </div>
