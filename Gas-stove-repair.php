...
<head>
    ...
    <title class="lng-services-aside_link3-3">Ремонт Газовой Плиты</title>
</head>
<body>
    ...
    <div class="container">
      <ul class="row">
        <li class="col-md-12 col-sm-12 col-xs-12">
            <h2 class="service_description_header lng-description_header3">Ремонт газовой плиты</h2>
          </li> 
        <li class="col-md-6 col-sm-6 col-xs-12">
          <div class="service_description_content">
            <img class="service_description_content_img" src="./img/services page/23190-1024x685.jpg" alt="">
            </div>
          </li>
        <li class="col-md-6 col-sm-6 col-xs-12">
        <div class="service_description_content">
              <h4 class="service_description_content_heading lng-description_content_heading3">Ремонт газовой плиты на дому</h4>
              <p class="service_description_content_info lng-description_content_info3">
              Ремонт газовой плиты производится на дому во всех районах Санкт-Петербурга и Ленинградской области. Мастера приезжают в день обращения. Перед приездом мастер проконсультирует по стоимости ремонта согласно неисправности. 
              <br>
              Газовая плита, и духовка – требуют серьезного отношения и профессионального подхода к ремонту, чтобы избежать аварийных ситуаций. Опытный и аттестованный мастер по ремонту газовой плиты произведёт ремонт и чистку вашей газовой плиты с использованием современного оборудования, предоставит гарантию на выполненные работы.
              </p>
            </div>
          </li>
        </ul>
        ...
        <div class="container">
            ...
            <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top"><b class="lng-service-card-heading10">Вызов и диагностика неисправности плиты по Душанбе</b>
                    <p class="section-favor_features lng-service-card-descr10">В стоимость входит Вызов, диагностика. Цена за услугу указана по Душанбе.</p>
                  </div>
              ...
              <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  ...
                  <b class="lng-service-card-heading11">Мелкий ремонт газовой плиты по Душанбе</b>
                    <p class="section-favor_features lng-service-card-descr11">Мастер осуществляет мелкий ремонт без разбора плиты. Цена за услугу указана по Душанбе.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
                    <p class="section-favor_bordery_price">100</p><p class="somoni lng-somoni2"> сомони</p>
                    <button class="section-favor_bordery_btn">
              ...
              <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top">
                  <b class="lng-service-card-heading12">Ремонт газовой плиты по Душанбе</b>
                    <p class="section-favor_features lng-service-card-descr12">Мастер осуществляет ремонт c разбором плиты, без стоимости запчастей. Цена за услугу указана по Душанбе.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
                    <p class="section-favor_bordery_price">150</p><p class="somoni lng-somoni3"> сомони</p>
                    <button class="section-favor_bordery_btn">
                    <a class="section-favor_bordery_btn_link lng-type-more3" namespace="lnk" href="#feedback">Подронее</a>
                    </button>
                    </div>
              ...
              <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top">
                  <b class="lng-service-card-heading13">Ремонт газовой плиты по пригороду</b>
                    <p class="section-favor_features lng-service-card-descr13">К стоимости ремонта и/или вызова на диагностику газовой плиты добавляется стоимость за дальность.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
