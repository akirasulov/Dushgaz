...
<head>
    ...
    <title class="lng-services-aside_link4-4">Демонтаж Газовых Труб</title>
</head>
<body>
    ...
    <div class="container">
      <ul class="row">
        <li class="col-md-12 col-sm-12 col-xs-12">
            <h2 class="service_description_header lng-description_header4">Демонтаж газовых труб</h2>
          </li>
        <li class="col-md-6 col-sm-6 col-xs-12">
          <div class="service_description_content">
            <img class="service_description_content_img" src="./img/services page/555-600x400.jpg" alt="">
            </div>
          </li>
        <li class="col-md-6 col-sm-6 col-xs-12">
        <div class="service_description_content">
              <h4 class="service_description_content_heading lng-description_content_heading4">Описание услуги демонтаж газовых труб</h4>
              <p class="service_description_content_info lng-description_content_info4">
                Специалисты нашей компании оказывают весь необходимый спектр услуг по газовым работам.
                Демонтаж газовых труб обычно требуется в следующих ситуациях:
               <br> &#8226; В случае большой степени износа и появления опасности дальнейшего использования газопровода;
               <br> &#8226; Если требуется ремонт или реконструкция зданий и помещений;
               <br> &#8226; В случае переноса газовых и других коммуникаций на другие участки;
               <br> &#8226; Когда возникает необходимость выноса газопровода из нежилых помещений.
              </p>
            </div>
          </li>
        </ul>
        ...
        <div class="container">
            ...
            <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top"><b class="lng-service-card-heading14">Вызов мастера на осмотр/консультацию и составление сметы по демонтажу газовых труб</b>
                    <p class="section-favor_features lng-service-card-descr14">В стоимость входит Вызов, консультация, расчеты работ по демонтажу газовой трубы.  Цена за услугу указана по Душанбе.</p>
                  </div>
              ...
              <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  ...
                  <b class="lng-service-card-heading15">Демонтаж газовых труб</b>
                    <p class="section-favor_features lng-service-card-descr15">В стоимость входит Вызов, консультация, расчеты работ по демонтажу газовой трубы.  Цена за услугу указана по Душанбе.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
              ...
              <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top">
                  <b class="lng-service-card-heading16">Демонтаж газовых труб в пригороде</b>
                    <p class="section-favor_features lng-service-card-descr16">В стоимость входит Вызов, консультация, расчеты работ по демонтажу газовой трубы.  Цена за услугу указана по Душанбе.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
                    <p class="section-favor_bordery_price">50</p><p class="somoni lng-somoni3"> сомони</p>
                    <button class="section-favor_bordery_btn">
