...
<head>
    ...
    <title class="lng-services-aside_link8-8">Установка Газового Счетчика</title>
</head>
<body>
    ...
    <div class="container">
      <ul class="row">
        <li class="col-md-12 col-sm-12 col-xs-12">
            <h2 class="service_description_header lng-description_header8">Установка газового счетчика</h2>
          </li>
        <li class="col-md-6 col-sm-6 col-xs-12">
          <div class="service_description_content">
            <img class="service_description_content_img" src="./img/services page/gas-meter_cropped_web-1-600x291.jpg" alt="">
            </div>
          </li>
        <li class="col-md-6 col-sm-6 col-xs-12">
        <div class="service_description_content">
              <h4 class="service_description_content_heading lng-description_content_heading8">Описание услуги установка газового счетчика</h4>
              <p class="service_description_content_info lng-description_content_info8">
              Установка газового счетчика, поможет вам сократить коммунальные расходы и даст возможность грамотно планировать бюджет.
             <br>Установка счетчика газа является обязательной только для потребителей, у кого максимальное потребление газа 2 кубометра газа в час и выше, а газ используется с целью отопления. Это означает, что жители многоквартирных домов у кого газ используется для приготовления пищи и/или для подогрева воды в санитарных целях попадают под исключение данного закона. Установить счетчик газа данные жители могут, но не в целях исполнения законодательства, а по собственному желанию для экономии. 
              </p>
            </div>
          </li>
        </ul>
        ...
        <div class="container">
            ...
            <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top"><b class="lng-service-card-heading27">Установка газового счетчика на плиту Душанбе (со счетчиком абонента/включая счетчик газа)</b>
                    <p class="section-favor_features lng-service-card-descr27">В стоимость входит Вызов, диагностика, услуги по установке, счетчик газа с пропускной способностью 1,6 кубометра газа в час.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
                    <p class="section-favor_bordery_price">230</p><p class="somoni lng-somoni"> сомони</p>
                    <button class="section-favor_bordery_btn">
                    <a class="section-favor_bordery_btn_link lng-type-more" namespace="lnk" href="#feedback">Подронее</a>
                    </button>
                    </div>
                </div>
              </li>
              <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  ...
                  <b class="lng-service-card-heading28">Установка газового счетчика по пригороду</b>
                    <p class="section-favor_features lng-service-card-descr28">В стоимость входит Вызов, диагностика, услуги по установке. Цена за услугу указана по Душанбе.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
              ...
              <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top">
                  <b class="lng-service-card-heading29">Установка газового счетчика на плиту и колонку Душанбе</b>
                    <p class="section-favor_features lng-service-card-descr29">В стоимость входит Вызов, диагностика, услуги по установке, счетчик газа с пропускной способностью 4 кубометра газа в час.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
                    <p class="section-favor_bordery_price">280</p><p class="somoni lng-somoni3"> сомони</p>
                    <button class="section-favor_bordery_btn">
              ...
              <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top"><b class="lng-service-card-heading30">Установка газового счетчика абонента с пропускной способностью 1,6 куб. газа / час</b>
                    <p class="section-favor_features lng-service-card-descr30">В стоимость входит Вызов, диагностика, услуги по установке. Цена за услугу указана по Душанбе.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
                    <p class="section-favor_bordery_price">235</p><p class="somoni lng-somoni4"> сомони</p>
                    <button class="section-favor_bordery_btn">
                    <a class="section-favor_bordery_btn_link lng-type-more4" namespace="lnk" href="#feedback">Подронее</a>
                    </button>
                    </div>
                </div>
              </li>
              <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top">
                  <b class="lng-service-card-heading31">Установка газового счетчика абонента с пропускной способностью 4 куб. газа / час</b>
                    <p class="section-favor_features lng-service-card-descr31">В стоимость входит Вызов, диагностика, услуги по установке. Цена за услугу указана по Душанбе.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
                    <p class="section-favor_bordery_price">280</p><p class="somoni lng-somoni5"> сомони</p>
                    <button class="section-favor_bordery_btn">
                    <a class="section-favor_bordery_btn_link lng-type-more5" namespace="lnk" href="#feedback">Подронее</a>
                    </button>
                    </div>
                </div>
              </li>
              <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top">
                  <b class="lng-service-card-heading32">Установка газового счетчика по пригороду </b>
                    <p class="section-favor_features lng-service-card-descr32">В стоимость входит Вызов, диагностика, услуги по установке. Цена за услугу указана по пригороду.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
                    <p class="section-favor_bordery_price">+50</p><p class="somoni lng-somoni6"> сомони</p>
                    <button class="section-favor_bordery_btn">
                    <a class="section-favor_bordery_btn_link lng-type-more6" namespace="lnk" href="#feedback">Подронее</a>
                    </button>
                    </div>
                </div>
              </li>
