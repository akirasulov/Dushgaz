...
<head>
    ...
    <title class="lng-services-aside_link14-14">Замена Газовой Трубы</title>
</head>
<body>
    ...
    <div class="container">
      <ul class="row">
        <li class="col-md-12 col-sm-12 col-xs-12">
            <h2 class="service_description_header lng-description_header13">Замена газовой трубы</h2>
          </li>
        <li class="col-md-6 col-sm-6 col-xs-12">
          <div class="service_description_content">
            <img class="service_description_content_img" src="./img/1469304238_truby-dlya-gaza-3-1.jpg" alt="">
            </div>
          </li>
        <li class="col-md-6 col-sm-6 col-xs-12">
        <div class="service_description_content">
              <h4 class="service_description_content_heading lng-description_content_heading13">Описание услуги замена газовой трубы</h4>
              <p class="service_description_content_info lng-description_content_info13">
              Замена газовой трубы в квартире в Душанбе — часто встречающаяся часть обслуживания газового оборудования. Это связано с тем, что многие газовые системы строились в середине прошлого века и успели потерять свою работоспособность.<br>По соображениям безопасности газовые трубы следует менять вовремя и прибегать к услугам только квалифицированных газовщиков-сварщиков. Штат специалистов нашей компании оказывает услуги по замене стальных газовых труб на новые в квартире, загородном частном доме, в производственных помещениях и других жилых и нежилых объектах в Душанбе с соблюдением всех норм и правил сварочных инженерных работ.
              </p>
            </div>
          </li>
        </ul>
        ...
        <div class="container">
            ...
            <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top"><b class="lng-service-card-heading50">Вызов мастера на осмотр/консультацию и составление</b>
                    <p class="section-favor_features lng-service-card-descr50">В стоимость входит Вызов, консультация, расчеты работ на замену газовой трубы. Цена за услугу указана по Душанбе.</p>
                  </div>
              ...
              <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  ...
                  <b class="lng-service-card-heading51">Замена газовой трубы в Душанбе</b>
                    <p class="section-favor_features lng-service-card-descr51">В стоимость входит Вызов, консультация, расчеты работ на замену газовой трубы. Цена за услугу указана по Душанбе.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
                    <p class="section-favor_bordery_price">150</p><p class="somoni lng-somoni5"> сомони</p>
                    <button class="section-favor_bordery_btn">
              ...
              <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top"><b class="lng-service-card-heading52">Замена газовой трубы в пригороде </b>
                    <p class="section-favor_features lng-service-card-descr52">В стоимость входит Вызов, консультация, услуги по замене газовой трубы.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
