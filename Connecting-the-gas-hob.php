...
<head>
    ...
    <title class="lng-services-aside_link11-11">Подключение Газовой Варочной Панели</title>
</head>
<body>
    ...
    <div class="container">
      <ul class="row">
        <li class="col-md-12 col-sm-12 col-xs-12">
            <h2 class="service_description_header lng-description_header11">Подключение газовой варочной панели</h2>
          </li> 
        <li class="col-md-6 col-sm-6 col-xs-12">
          <div class="service_description_content">
            <img class="service_description_content_img" src="./img/1736_6381-1024x682.png" alt="">
            </div>
          </li>
        <li class="col-md-6 col-sm-6 col-xs-12">
        <div class="service_description_content">
              <h4 class="service_description_content_heading lng-description_content_heading11">Подключение варочной панели, как происходит, особенности</h4>
              <p class="service_description_content_info lng-description_content_info11">
              Газовая варочная поверхность на первый взгляд – весьма простое устройство, в подключении которой нет ничего сложного, но на деле оказывается, что не все так просто. Установка газовой поверхности должна быть выполнена с соблюдением норм технической безопасности, в соответствии с прилагаемой к ней инструкцией. При подключении данного прибора к газопроводу надо быть очень внимательным и аккуратным, потому что утечка газа может повлечь за собой печальные последствия.
              </p>
            </div>
          </li>
        </ul>
        ...
        <div class="container">
            ...
            <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top"><b class="lng-service-card-heading39">Вызов мастера по Душанбе</b>
                    <p class="section-favor_features lng-service-card-descr39">Вызов мастера бесплатный только по Душанбе.</p>
                  </div>
              ...
              <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  ...
                  <b class="lng-service-card-heading40">Стоимость установки и подключения варочной панели</b>
                    <p class="section-favor_features lng-service-card-descr40">В стоимость входит Вызов, услуги по установке. Мастер осуществляет установку без перемонтажа газовых труб. Цена за услугу указана по Душанбе.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
                    <p class="section-favor_bordery_price">180</p><p class="somoni lng-somoni3"> сомони</p>
                    <button class="section-favor_bordery_btn">
              ...
              <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top"><b class="lng-service-card-heading41">Стоимость установки и подключения варочной панели за пределы города</b>
                    <p class="section-favor_features lng-service-card-descr41">В стоимость входит Вызов, услуги по установке. Мастер осуществляет установку без перемонтажа газовых труб.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
                    <p class="section-favor_bordery_price">+50</p><p class="somoni lng-somoni4"> сомони</p>
                    <button class="section-favor_bordery_btn">
              ...
              <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top">
                  <b class="lng-service-card-heading42">Стоимость установки духового шкафа в Душанбе</b>
                    <p class="section-favor_features lng-service-card-descr42">В стоимость входит Вызов, услуги по установке. Мастер осуществляет установку без перемонтажа газовых труб. Цена за услугу указана по Душанбе.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
                    <p class="section-favor_bordery_price">180</p><p class="somoni lng-somoni5"> сомони</p>
                    <button class="section-favor_bordery_btn">
              ...
              <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top">
                  <b class="lng-service-card-heading43">Стоимость установки и подключения варочной панели + духового шкафа</b>
                    <p class="section-favor_features lng-service-card-descr43">В стоимость входит Вызов, услуги по установке. Мастер осуществляет установку без перемонтажа газовых труб. Цена за услугу указана по Душанбе.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
                    <p class="section-favor_bordery_price">270</p><p class="somoni lng-somoni6"> сомони</p>
                    <button class="section-favor_bordery_btn">
