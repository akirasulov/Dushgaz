...
<head>
    ...
    <title class="lng-services-aside_link10-10">Установка Газовой Плиты</title>
</head>
<body>
    ...
    <div class="container">
      <ul class="row">
        <li class="col-md-12 col-sm-12 col-xs-12">
            <h2 class="service_description_header lng-description_header10">Установка газовой плиты</h2>
          </li>  
        <li class="col-md-6 col-sm-6 col-xs-12">
          <div class="service_description_content">
            <img class="service_description_content_img" src="./img/ae60d9973edfee8de4c4335b40293495-600x400.jpg" alt="">
            </div>
          </li>
        <li class="col-md-6 col-sm-6 col-xs-12">
        <div class="service_description_content">
              <h4 class="service_description_content_heading lng-description_content_heading10">Описание услуги установка газовой плиты</h4>
              <p class="service_description_content_info lng-description_content_info10">
              Установка газовой плиты (подключение газовой плиты) проводится в квартирах, домах, кафе по Душанбе.     <br>Профессиональная установка и подключение газовой плиты исключает утечку газа и иные недоработки.Предоставляется гарантия на все виды профессиональных услуг. Установка проводится комплексно с демонтажем газовой плиты установленной ранее.
              </p>
            </div>
          </li>
        </ul>
        ...
        <div class="container">
            ...
            <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top"><b class="lng-service-card-heading37">Установка газовой плиты в Душанбе</b>
                    <p class="section-favor_features lng-service-card-descr37">В стоимость входит Вызов, услуги по установке. Мастер осуществляет установку без перемонтажа газовых труб. Цена за услугу указана по Душанбе</p>
                  </div>
              ...
              <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  ...
                  <b class="lng-service-card-heading38">Установка газовой плиты за пределы города</b>
                    <p class="section-favor_features lng-service-card-descr38">В стоимость входит Вызов, услуги по установке. Мастер осуществляет установку без перемонтажа газовых труб. Цена за услугу указана за пределы города Душанбе.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
