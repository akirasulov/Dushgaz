...
<head>
    ...
    <title class="lng-services-aside_link5-5">Обслуживание Газовой Колонки</title>
</head>
<body>
    ...
    <div class="container">
      <ul class="row">
        <li class="col-md-12 col-sm-12 col-xs-12">
            <h2 class="service_description_header lng-description_header5">Обслуживание газовой колонки</h2>
          </li>
        <li class="col-md-6 col-sm-6 col-xs-12">
          <div class="service_description_content">
            <img class="service_description_content_img" src="./img/services page/ustanovka-i-podklyuchenie-gazovoy-kolonki-1-300x261.jpg" alt="">
            </div>
          </li>
        <li class="col-md-6 col-sm-6 col-xs-12">
        <div class="service_description_content">
              <h4 class="service_description_content_heading lng-description_content_heading5">Описание услуги обслуживание газовой колонки</h4>
              <p class="service_description_content_info lng-description_content_info5">
                К основным сервисным операциям по обслуживанию газовой колонки можно отнести очистку системы газовой колонки от накопившихся загрязнений, а также настройку режимов горения. 
                <br>
                Своевременное обслуживание газовых колонок позволит избежать следующих проблем:
                <br>Колонка не загорается (по причине отсутствия тяги в дымоходе, разрядки элементов питания, отсутствия напора воды и так далее).
                <br>Колонка загорается, но сразу затухает (например, из-за не отрегулированной подачи воды – холодной или горячей).
                <br>Во время включения колонки слышны посторонние звуки (хлопки).
                <br>Образование течи радиатора колонки.
              </p>
            </div>
          </li>
        </ul>
        ...
        <div class="container">
            ...
            <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top"><b class="lng-service-card-heading17">Обслуживание газовой колонки по Душанбе</b>
                    <p class="section-favor_features lng-service-card-descr17">В стоимость входит Вызов, диагностика, услуги по обслуживанию или ремонту. Цена за услугу указана по Душанбе.</p>
                  </div>
              ...
              <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  ...
                  <b class="lng-service-card-heading18">Облуживание газовой колонки по пригороду</b>
                    <p class="section-favor_features lng-service-card-descr18">В стоимость входит Вызов, диагностика, услуги по обслуживанию. Цена за услугу указана по пригороду.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
