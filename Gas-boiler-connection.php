    ...
    <div class="container">
      <ul class="row">
        <li class="col-md-12 col-sm-12 col-xs-12">
            <h2 class="service_description_header lng-description_header12">Подключение газового котла</h2>
          </li>
        <li class="col-md-6 col-sm-6 col-xs-12">
          <div class="service_description_content">
            <img class="service_description_content_img" src="./img/1215256.jpg" alt="">
            </div>
          </li>
        <li class="col-md-6 col-sm-6 col-xs-12">
        <div class="service_description_content">
              <h4 class="service_description_content_heading lng-description_content_heading12">Подключение газового котла, как происходит, особенности</h4>
              <p class="service_description_content_info lng-description_content_info12">
              Подключение газового котла для отопления дома, используя магистральный газопровод для подачи газа,  значительно удешевляет обогрев помещений. Если вы определенно приняли решение отапливать свой дом природным или сжиженным газом, необходимо проанализировать условия и возможности подключения к газовой магистрали, а также знать как правильно подключится, чтобы в помещениях все время было тепло.
              </p>
            </div>
          </li>
        </ul>
        ...
        <div class="container">
            ...
            <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top"><b class="lng-service-card-heading44">Вызов мастера на диагностику и составление сметы</b>
                    <p class="section-favor_features lng-service-card-descr44">Вызов мастера для осмотра объма работ, составления сметы и визуальной диагностики существующей системы отопления.</p>
                  </div>
              ...
              <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  ...
                  <b class="lng-service-card-heading45">Монтаж и подключение настенного котла</b>
                    <p class="section-favor_features lng-service-card-descr45">Установка настенного одноконтурного котла, подключение к дымоходу, подключение к системе отопления и водоснабжения без перемонтажа.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
                    <p class="section-favor_bordery_price">80</p><p class="somoni lng-somoni3"> сомони</p>
                    <button class="section-favor_bordery_btn">
              ...
              <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top"><b class="lng-service-card-heading46">Монтаж и подключение напольного котла до 140 кВт</b>
                    <p class="section-favor_features lng-service-card-descr46">Установка напольного котла до 140 кВт, подключение к дымоходу, подключение к системе отопления и водоснабжения без перемонтажа. </p>
                  </div>
                    <div class="section-favor_bordery_direction">
                    <p class="section-favor_bordery_price">200</p><p class="somoni lng-somoni4"> сомони</p>
                    <button class="section-favor_bordery_btn">
              ...
              <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top">
                  <b class="lng-service-card-heading47">Монтаж и подключение настенного котла (двухконтурный)</b>
                    <p class="section-favor_features lng-service-card-descr47">Установка настенного двухконтурного котла, подключение к дымоходу, подключение к системе отопления и водоснабжения без перемонтажа.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
                    <p class="section-favor_bordery_price">100</p><p class="somoni lng-somoni5"> сомони</p>
                    <button class="section-favor_bordery_btn">
              ...
              <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top">
                  <b class="lng-service-card-heading48">Монтаж и подключение напольного котла до 60 кВт</b>
                    <p class="section-favor_features lng-service-card-descr48">Установка напольного котла до 60 кВт, подключение к дымоходу, подключение к системе отопления и водоснабжения без перемонтажа.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
                    <p class="section-favor_bordery_price">140</p><p class="somoni lng-somoni6"> сомони</p>
                    <button class="section-favor_bordery_btn">
              ...
              <li class="col-lg-4 section-favor_container">
                <div class="section-favor_bordery">
                  <div class="section-favor_bordery_top">
                  <b class="lng-service-card-heading49">Монтаж и подключение напольного котла более 140 кВт</b>
                    <p class="section-favor_features lng-service-card-descr49">Установка напольного котла более 140 кВт, подключение к дымоходу, подключение к системе отопления и водоснабжения без перемонтажа.</p>
                  </div>
                    <div class="section-favor_bordery_direction">
                    <p class="section-favor_bordery_price"></p>
                    <button class="section-favor_bordery_btn">
